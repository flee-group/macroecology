...
library(sf)
library(fasterize)
mamm = st_read("../data/mammals/MAMMALS_TERRESTRIAL_ONLY.shp")
mamm = st_crop(mamm, clim_pres)
mamm = st_cast(mamm, "MULTIPOLYGON")
saveRDS(mamm, "../data/mammal_ranges.rds")
mr = fasterize(mamm, clim_pres[[1]], fun = "sum", background = 0)
plot(mr, col=scico::scico(100))
```
